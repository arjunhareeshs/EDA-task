...
# installed.
TCL_PREFIX='C:/environment/day 2(13-8-25)/anaconda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/environment/day 2(13-8-25)/anaconda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/environment/day 2(13-8-25)/anaconda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/environment/day 2(13-8-25)/anaconda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/environment/day 2(13-8-25)/anaconda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/environment/day 2(13-8-25)/anaconda\Library\lib\tclstub86.lib'
